...
def capabilities() -> str:
    ...
    return "\n".join(
        [
            ...
            " quick reproduction/localization; orchestrator holds no bash/python/edit/shell and"
            " forks children instead (agents/memory/system/skill only). model and thinking are"
            " launch overrides. budget=N sets a child's spawn depth budget (default 0: children"
            " cannot fork; orchestrator defaults to 1); a spawn past the budget returns a refusal"
